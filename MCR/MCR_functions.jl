...
function UnimodalLeastSquares(A::Union{Array{Float64,1}, Array{Float64,2}}, b::Union{Array{Float64,1}, Array{Float64,2}};
...
function MCR_ALS_jw_March29(X, C::Union{Nothing, Array{Float64,1}, Array{Float64,2}}, S::Union{Nothing, Array{Float64,1}, Array{Float64,2}};
    Factors::Int = 3, maxiters::Int = 20, constraintiters::Int = 50, norm::Tuple{Bool,Bool} = (false, false), nonnegative::Tuple{Bool,Bool} = (true, true),
    unimodalC::Bool = false, unimodalS::Bool = false, fixedunimodal::Bool = false )
